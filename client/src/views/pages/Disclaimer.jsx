            ...
            <Container className="py-lg-md d-flex">
              <div className="col px-2">
                <Col>
                  ...
                  external sites. While we strive to provide only quality links
                  ...
                  remove a link which may have gone 'bad'. Please be also aware
                  that when you leave our website, other sites may have
                  different privacy policies and terms which are beyond our
                  control. Please be sure to check the Privacy Policies of these
                  sites as well as their "Terms of Service" before engaging in
